...
def callback(message):
  ...
  try:
    ...
    transform = tfBuffer.lookup_transform('reference/base', 'reference/head_camera', rospy.Time()).transform  
    ...
    translation1 = transform2.translation
    translation_w1 = [translation1.x, translation1.y, translation1.z]
    rot2 = transform2.rotation
    rotation_w1 = R.from_quat([rot1.x, rot1.y, rot1.z, rot1.w])
    print(rotation_w1)
    ...
    rot2 = transform2.rotation
    rotation_w2 = R.from_quat([rot2.x, rot2.y, rot2.z, rot2.w])
    ...
    rotation_w3 = R.from_quat([rot3.x, rot3.y, rot3.z, rot3.w])
    ...
    rotation_w4 = R.from_quat([rot4.x, rot4.y, rot4.z, rot4.w])
    ...
    rotation_w5 = R.from_quat([rot5.x, rot5.y, rot5.z, rot5.w])
    ...
    m1_wf = transform_wf(m1, rotation_w, translation_w)
    ...
    pub.publish(VisualData (obj_length,obj_width,m1_wf,m2_wf,m3_wf,m4_wf,human_ar_wf))

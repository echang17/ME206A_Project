...
(cl:defclass <AlvarMarkers> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (markers
    :reader markers
    :initarg :markers
    :type (cl:vector planner-msg:AlvarMarker)
   :initform (cl:make-array 0 :element-type 'planner-msg:AlvarMarker :initial-element (cl:make-instance 'planner-msg:AlvarMarker))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <AlvarMarkers>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AlvarMarkers)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name planner-msg:<AlvarMarkers> is deprecated: use planner-msg:AlvarMarkers instead.")))
...
(cl:defmethod markers-val ((m <AlvarMarkers>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader planner-msg:markers-val is deprecated.  Use planner-msg:markers instead.")
  (markers m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <AlvarMarkers>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'markers)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'planner-msg:AlvarMarker))
